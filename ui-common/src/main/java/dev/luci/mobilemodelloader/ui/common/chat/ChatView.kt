...
package dev.luci.mobilemodelloader.ui.common.chat

// import dev.luci.mobilemodelloader.ui.preview.PreviewChatModel
// import dev.luci.mobilemodelloader.ui.preview.PreviewModelManagerViewModel
// import dev.luci.mobilemodelloader.ui.preview.TASK_TEST1
// import dev.luci.mobilemodelloader.ui.theme.GalleryTheme
...
import dev.luci.mobilemodelloader.ui.common.copyBitmapToClipboard
import dev.luci.mobilemodelloader.ui.common.saveBitmapToMediaStore
import dev.luci.mobilemodelloader.ui.common.shareBitmap
...
/**
 * Deserializes a list of [dev.luci.mobilemodelloader.proto.ChatMessageProto] from persistent
...
private fun deserializeProtoMessages(
  protoMessages: List<dev.luci.mobilemodelloader.proto.ChatMessageProto>
): List<ChatMessage> {
  return protoMessages.mapNotNull { protoMsg ->
    val side =
      when (protoMsg.side) {
        dev.luci.mobilemodelloader.proto.ChatSideProto.CHAT_SIDE_USER -> ChatSide.USER
        dev.luci.mobilemodelloader.proto.ChatSideProto.CHAT_SIDE_MODEL -> ChatSide.AGENT
        dev.luci.mobilemodelloader.proto.ChatSideProto.CHAT_SIDE_SYSTEM -> ChatSide.SYSTEM
