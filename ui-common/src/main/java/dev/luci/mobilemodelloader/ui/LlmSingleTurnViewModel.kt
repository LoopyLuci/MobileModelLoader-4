...
import dev.luci.mobilemodelloader.common.processLlmResponse
...
class LlmSingleTurnViewModel @Inject constructor(private val repository: ) : ViewModel() {
    ...
    viewModelScope.launch(Dispatchers.Default) {
      ...
      val supportImage =
        model.llmSupportImage &&
          task.id == dev.luci.mobilemodelloader.data.BuiltInTaskId.LLM_ASK_IMAGE
      val supportAudio =
        model.llmSupportAudio &&
          task.id == dev.luci.mobilemodelloader.data.BuiltInTaskId.LLM_ASK_AUDIO
