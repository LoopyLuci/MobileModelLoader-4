...
package dev.luci.mobilemodelloader.ui.modelmanager
...
import dev.luci.mobilemodelloader.AppLifecycleProvider
import dev.luci.mobilemodelloader.BuildConfig
import dev.luci.mobilemodelloader.R
import dev.luci.mobilemodelloader.common.ProjectConfig
import dev.luci.mobilemodelloader.common.SystemPromptHelper
import dev.luci.mobilemodelloader.common.getJsonResponse
import dev.luci.mobilemodelloader.common.isAICoreSupported
import dev.luci.mobilemodelloader.customtasks.common.CustomTask
import dev.luci.mobilemodelloader.data.Accelerator
import dev.luci.mobilemodelloader.data.BuiltInTaskId
import dev.luci.mobilemodelloader.data.Category
import dev.luci.mobilemodelloader.data.CategoryInfo
import dev.luci.mobilemodelloader.data.Config
import dev.luci.mobilemodelloader.data.ConfigKeys
import dev.luci.mobilemodelloader.data.DataStoreRepository
import dev.luci.mobilemodelloader.data.DownloadRepository
import dev.luci.mobilemodelloader.data.EMPTY_MODEL
import dev.luci.mobilemodelloader.data.IMPORTS_DIR
import dev.luci.mobilemodelloader.data.Model
import dev.luci.mobilemodelloader.data.ModelAllowlist
import dev.luci.mobilemodelloader.data.ModelCapability
import dev.luci.mobilemodelloader.data.ModelDownloadStatus
import dev.luci.mobilemodelloader.data.ModelDownloadStatusType
import dev.luci.mobilemodelloader.data.NumberSliderConfig
import dev.luci.mobilemodelloader.data.RuntimeType
import dev.luci.mobilemodelloader.data.SOC
import dev.luci.mobilemodelloader.data.SystemPromptRepository
import dev.luci.mobilemodelloader.data.TMP_FILE_EXT
import dev.luci.mobilemodelloader.data.Task
import dev.luci.mobilemodelloader.data.ValueType
import dev.luci.mobilemodelloader.data.createLlmChatConfigs
import dev.luci.mobilemodelloader.data.markInitializationFailed
import dev.luci.mobilemodelloader.data.markInitializationStarted
import dev.luci.mobilemodelloader.data.markInitialized
import dev.luci.mobilemodelloader.data.resetInitialization
import dev.luci.mobilemodelloader.firebaseAnalytics
import dev.luci.mobilemodelloader.huggingface.HuggingFaceApiClient
import dev.luci.mobilemodelloader.proto.AccessTokenData
import dev.luci.mobilemodelloader.proto.HfModelItemProto
import dev.luci.mobilemodelloader.proto.ImportedModel
import dev.luci.mobilemodelloader.proto.Theme
import dev.luci.mobilemodelloader.runtime.aicore.AICoreModelHelper
