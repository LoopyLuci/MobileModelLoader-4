...
import dev.luci.mobilemodelloader.common.SkillTryOutChip
import dev.luci.mobilemodelloader.data.AllowedSkill
...
class SkillManagerViewModel @Inject constructor(private val repository: val skillManager: SkillManager) : ViewModel() {
