...
data class Model(
   ...
   * - `dev.luci.mobilemodelloader` for other builds (Play store, internal, etc).
   *
   ...
   *
   * /storage/emulated/0/Android/data/dev.luci.mobilemodelloader/files/my_model/local_dir/
   *
