...
package dev.luci.mobilemodelloader.runtime.aicore

import android.content.Context
import android.graphics.Bitmap
import android.util.Log
import dev.luci.mobilemodelloader.common.cleanUpMediapipeTaskErrorMessage
import dev.luci.mobilemodelloader.data.AICoreModelPreference
import dev.luci.mobilemodelloader.data.AICoreModelReleaseStage
import dev.luci.mobilemodelloader.data.ConfigKeys
import dev.luci.mobilemodelloader.data.DEFAULT_MAX_OUTPUT_TOKEN
...
object AICoreModelHelper : LlmModelHelper {
  ...
  private fun logAICoreAccessDetails(context: Context) {
    ...
    val allowedPackages =
      setOf(
        "dev.luci.mobilemodelloader",
        "dev.luci.mobilemodelloader.internal",
        "dev.luci.mobilemodelloader.dev",
      )
